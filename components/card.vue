<template>
  ...
  >
    ...
    >
      <span
        class="icon-star-circle-fill text-sm mr-1.5 mt-0.5 md:m-0 md:mb-1"
      ></span>
      <div
        class="flex sm:flex-row md:flex-col text-center text-sm font-light tracking-wide leading-4"
      >
    ...
    <div
      class="sm:p-3 md:p-5 truncate flex flex-col justify-center items-start"
    >
...
<script setup lang="ts">
  const props = defineProps({
    ...
    overtime: {
      // '1':準時上下班; '2':很少加班; '3':偶爾加班; '4':常常加班; '5':賣肝拼經濟
      type: String,
      required: true,
    },
    feeling: {
      // '1':非常開心; '2':還算愉快; '3':平常心; '4':有苦說不出; '5':想換工作了
      type: String,
      required: true,
    },
  });
