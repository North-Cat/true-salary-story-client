  ...
  <div class="default-layout max-[1920px]:overflow-x-hidden">
    ...
    >
      <div class="flex justify-between">
        ...
        <!-- 訊息 sm md -->
        <BaseButton v-if="isLogin" cate="text-sm" class="message-button" @click="goToConsult">
          <div class="-mb-1">
            <!-- 訊息紅點 -->
    ...
    >
      <div class="container mx-auto max-w-[1800px] flex justify-between items-center">
        ...
        <div class="hidden lg:flex flex-row justify-center items-center">
          ...
          <!-- 訊息 lg -->
          <div class="relative">
            <BaseButton v-if="isLogin" cate="gray-text" class="message-button" @click="goToConsult">
              <div>
                <!-- 訊息紅點 -->
                <span v-show="hasNewMessage" class="absolute right-1 flex h-3 w-3 message-button">
                  <span
