...
<template>
  <div class="login h-[90vh] md:h-screen w-screen flex justify-center items-center">
    <section class="px-4">
      <svg
        ...
        width="406"
        height="306"
        class="illustration styles_illustrationTablet__1DWOa max-w-full"
      >
      ...
      <h2 class="text-xl md:text-4xl text-center mb-10 mt-[-50px]">你搜尋的頁面找不到</h2>
      <BaseButton cate="primary" to="/" class="w-[200px] max-w-full mx-auto"> 回到首頁 </BaseButton>
    </section>
  </div>
</template>
