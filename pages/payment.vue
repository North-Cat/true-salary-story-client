<template>
  <section
    class="bg-gray sm:py-10 md:py-10 lg:pt-20 lg:pb-1 max-[1920px]:overflow-x-hidden"
  >
    <div
    ...
    >
      <div class="w-full flex flex-col lg:justify-between sm:mb-10 lg:mb-20">
        ...
        <!-- 計畫介紹 -->
        <div
          v-if="isTab(Tab.PAYMENT)"
          class="w-full flex border-2 border-black-10 p-6 bg-white"
        >
          <div
            class="w-1/3 flex flex-col border border-black-1 py-5 px-6 rounded me-3"
          >
            ...
            <div class="flex justify-between pb-5 border-b border-black-1 mb-5">
              <div class="w-9/12 border border-black-1 rounded p-2 me-2">
                1000 積分
              </div>
            ...
            <div class="h-full flex flex-col justify-between">
              <div class="flex pb-5 border-b border-black-1 mb-5">
                <div
                  class="icon-sparkle-checked text-blue text-md pt-1 mr-3"
                ></div>
                <div>
              ...
              <div class="flex">
                ...
                <div class="caption text-black-5">
                  贈送積分使用期限為購買日期後 6 個月
                </div>
              </div>
            </div>
          ...
          <div
            class="w-1/3 flex flex-col border border-black-1 py-5 px-6 rounded"
          >
            <div
              class="h-full flex flex-col pb-5 mb-5 justify-center items-center"
            >
              <div class="flex flex-col">
        ...
        <div
          ...
          class="w-full flex flex-col border-2 border-black-10 py-6 px-20 bg-white"
        >
          <div class="flex flex-col border border-black-1 me-3 rounded">
            <div
              class="w-full flex justify-between items-center py-5 px-6 cursor-pointer"
              @click="open(1)"
            >
              <h6>付款方式有哪些？</h6>
          ...
          <div class="flex flex-col border border-black-1 me-3 rounded">
            ...
            <p
              :class="{ hidden: !isOpen(2), block: isOpen(2) }"
              class="caption pb-5 px-6"
            >
          ...
          <div class="flex flex-col border border-black-1 me-3 rounded">
            ...
            <p
              :class="{ hidden: !isOpen(3), block: isOpen(3) }"
              class="caption pb-5 px-6"
            >
              訂閱加薪計畫，付款成功後即刻獲得 VIP
              會員資格，生效日以付款當下的日期起算。<br />
              例：於 2022.01.01 成立購買訂單，付款方式為 Line Pay，在 2022.01.02
              付款成功，VIP 會員資格將由 2022.01.02 往前往後推算 6 個月喔！
            </p>
          </div>
          ...
          <div class="flex flex-col border border-black-1 me-3 rounded">
            ...
            <p
              :class="{ hidden: !isOpen(4), block: isOpen(4) }"
              class="caption pb-5 px-6"
            >
              加薪計畫到期後，VIP
              會員權限將會即刻中止，若想持續升級，請到方案説明頁再次下單即可。<br />
              真薪話並不會主動幫你續約，請放心！
            </p>
          </div>

          <div
            class="flex justify-between items-center border border-black-1 me-3 py-5 px-6 rounded mt-20"
          >
...
<script setup lang="ts">
  ...
  const tabClass = computed(() => (tab: Tab) => {
    const className = isTab(tab)
      ? 'border-b-2 text-blue border-b-blue'
