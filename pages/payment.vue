      ...
      <div class="w-full flex flex-col lg:justify-between sm:mb-10 lg:mb-20">
        ...
        <div v-if="isTab(Tab.PAYMENT)" class="w-full flex border-2 border-black-10 p-6 bg-white">
          <div class="w-1/3 flex flex-col border border-black-1 py-5 px-6 rounded me-3">
            <div class="flex justify-between items-center mb-5">
              ...
              <div class="icon-star-circle text-5xl">
              </div>
            </div>
          ...
          <div class="w-1/3 flex flex-col border border-black-1 py-5 px-6 rounded me-3">
            <div class="flex justify-between items-center mb-5">
              ...
              <div class="icon-fire text-6xl text-blue">
              </div>
            </div>
            <div class="flex justify-between pb-5 border-b border-black-1 mb-5">
        ...
        <div v-if="isTab(Tab.QUESTION)" class="w-full flex flex-col border-2 border-black-10 py-6 px-20 bg-white">
          ...
          <div class="flex flex-col border border-black-1 me-3 rounded">
            <div @click="open(1)" class="w-full flex justify-between items-center py-5 px-6 cursor-pointer ">
              <h6>付款方式有哪些？</h6>
          ...
          <div class="flex flex-col border border-black-1 me-3 rounded">
            <div @click="open(2)" class="w-full flex justify-between items-center py-5 px-6 cursor-pointer ">
              <h6>可以打統編嗎？</h6>
          ...
          <div class="flex flex-col border border-black-1 me-3 rounded">
            <div @click="open(3)" class="w-full flex justify-between items-center py-5 px-6 cursor-pointer ">
            ...
            <p :class="{ 'hidden': !isOpen(3), 'block': isOpen(3) }" class="caption pb-5 px-6">
              ...
              例：於 2022.01.01 成立購買訂單，付款方式為 Line Pay，在 2022.01.02 付款成功，VIP 會員資格將由
              2022.01.02 往前往後推算 6 個月喔！
            </p>
          </div>

          <div class="flex flex-col border border-black-1 me-3 rounded">
            <div @click="open(4)" class="w-full flex justify-between items-center py-5 px-6 cursor-pointer ">
