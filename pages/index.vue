    ...
    <div v-if="isInit" class="loading fixed top-0 left-0 w-screen h-screen bg-white z-[999]">
      <div class="w-full h-full flex justify-center items-center flex-col">
        ...
        <div class="sm-loading block lg:hidden w-[100px]">
          ...
          >
            <path
              d="M38.3684 126.91C69.7303 196.606 220.616 125.857 183.323 54.1697C146.03 -17.5179 5.2891 53.3975 38.3684 126.91Z"
              fill="#8CB4E4"
            />
            <path
              d="M10.4951 19.3772C13.7893 18.164 17.4432 19.8509 18.6564 23.1451C20.1889 27.306 24.5725 33.4604 31.0135 38.9295C37.3948 44.3479 45.0212 48.4302 52.5065 49.388C55.9886 49.8336 58.4502 53.0175 58.0046 56.4996C57.5591 59.9817 54.3751 62.4433 50.893 61.9977C40.1987 60.6293 30.3491 55.0424 22.7853 48.6199C15.2812 42.2482 9.25064 34.3902 6.72723 27.5386C5.51401 24.2444 7.20093 20.5904 10.4951 19.3772Z"
              fill="#2B2B31"
            />
            <path
              d="M111.934 13.7064C132.424 15.0206 151.634 24.5088 162.338 46.9023C176.982 77.5363 159.637 107.73 134.672 126.806C109.668 145.912 73.9805 156.494 46.1 146.648C23.8895 138.805 2.18796 112.02 12.6033 72.2817C13.4933 68.8859 16.9676 66.8546 20.3634 67.7446C23.7591 68.6346 25.7905 72.1089 24.9004 75.5047C16.2294 108.588 34.101 128.929 50.3331 134.661C72.7734 142.586 103.99 134.252 126.954 116.705C149.958 99.1268 161.646 74.9296 150.869 52.385C142.508 34.8938 127.909 27.4697 111.12 26.3929C94.0032 25.295 74.8357 30.8975 59.112 39.5833C56.0392 41.2808 52.1721 40.1658 50.4747 37.093C48.7773 34.0202 49.8922 30.1532 52.965 28.4557C70.1893 18.941 91.7713 12.4132 111.934 13.7064Z"
              fill="#2B2B31"
            />
            <path
              d="M104.767 61.6723C106.923 58.9017 110.917 58.4032 113.687 60.5589L121.489 66.6291C124.259 68.7848 124.758 72.7784 122.602 75.549C120.446 78.3196 116.453 78.818 113.682 76.6623L105.881 70.5922C103.11 68.4364 102.612 64.4429 104.767 61.6723Z"
              fill="#2B2B31"
            />
            <path
              d="M77.8896 76.071C80.0453 73.3004 84.0389 72.8019 86.8095 74.9576L94.6111 81.0278C97.3817 83.1835 97.8801 87.1771 95.7244 89.9477C93.5687 92.7183 89.5751 93.2168 86.8045 91.061L79.0029 84.9909C76.2323 82.8352 75.7339 78.8416 77.8896 76.071Z"
              fill="#2B2B31"
            />
            <path
              d="M51.0118 86.4697C53.1675 83.6991 57.1611 83.2006 59.9317 85.3563L67.7333 91.4265C70.5039 93.5822 71.0023 97.5758 68.8466 100.346C66.6909 103.117 62.6973 103.615 59.9267 101.46L52.1251 95.3896C49.3545 93.2339 48.8561 89.2403 51.0118 86.4697Z"
              fill="#2B2B31"
            />
          </svg>
        </div>
