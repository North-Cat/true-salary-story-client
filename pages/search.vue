...
function search() {
  ...
  titleResultsCount.value = 100;
  titleTotalPages.value = titleResultsCount.value / limit.value;
    ...
    >
      <div class="w-full max-w-[1076px] flex flex-col border-2 border-black-10 bg-white py-10 px-5 mb-10">
        ...
        <div class="flex flex-col">
          ...
          <!-- 找職位 -->
          <div v-if="(isTab(SearchType.KEYWORD) || isTab(SearchType.JOB_TITLE)) && titleResults">
            <div v-for="title in titleResults" :key="title.taxId" class="mb-10">
          ...
          <!-- 找產業 -->
          <div v-if="(isTab(SearchType.KEYWORD) || isTab(SearchType.COMPANY_TYPE)) && typeResults">
            <div v-for="comType in typeResults" :key="comType.taxId" class="mb-10">
