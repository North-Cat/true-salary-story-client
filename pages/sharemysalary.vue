...
<template>
  <section class="bg-gray sm:py-10 md:py-10 lg:py-20 max-[1920px]:overflow-x-hidden">
    <div class="sharemysalary container mx-auto sm:max-w-[350px] md:max-w-[600px] lg:max-w-7xl lg:mt-10">
      ...
      <div class="lg:w-4/6 border-2 border-black-10 mt-20 md:mt-10 lg:mt-0 rounded-bl rounded-br">
        ...
        <form class="min-h-full md:min-h-[300px] p-6 bg-white" ref="form">
          <div v-show="step === 1">
            ...
            <!-- 在職狀況 -->
            <div class="mb-10">
              <BaseFormRadio v-model="submitData.inService" :options="isServerOptions" label="在職狀況" input-name="isService"
                isButtonStyle />
            </div>
            ...
            <!-- 薪資情況 -->
            <div class="mb-10">
              <BaseFormRadio v-model="salaryTypes" :options="salaryTypesOpions" label="薪資情況（新台幣）" input-name="salaryTypes"
              ...
              <div class="mt-4">
                <div class="pl-12">
                    ...
                    <template v-if="salaryTypes === 'daily'">
                      <div class="flex">
                        <div class="shrink w-full">
                          <input v-model="salaryTypesField[salaryTypes].salary" type="text" name="salary" placeholder="日薪"
                            class="w-full border border-black-1 rounded py-2 pl-4 pr-9">
                        </div>
                  ...
                  <keep-alive>
                    <template v-if="salaryTypes === 'hourly'">
                      <div class="flex">
                        <div class="shrink w-full">
                          <input v-model="salaryTypesField[salaryTypes].salary" type="text" name="salary" placeholder="時薪"
                            class="w-full border border-black-1 rounded py-2 pl-4 pr-9">
                        </div>
                        <div class="w-[48px] flex items-center justify-center px-5"><i
                            class="icomoon icon-cross text-black-6"></i>
                ...
                <div class="flex mt-3">
                  ...
                  <div class="shrink w-full">
                    <input v-model="submitData.profitSharingBonus" type="text" name="profitSharingBonus" placeholder="獎金"
                      class="w-full border border-black-1 rounded py-2 pl-4 pr-9">
                  </div>
                </div>
                <!-- 其他 -->
            ...
            <div class="mb-10">
              ...
              <ul class="flex flex-wrap list-none mb-3">
                <li v-for="(tagsItem, $index) in tagsOptions">
                  ...
                  <label v-if="tagsItem.status === 'good'" :for="`tagsItemGood-${$index}`" :key="`tagsItemGood-${$index}`"
      ...
      <div class="lg:w-2/6 lg:mr-[30px] lg:mt-0 md:mt-15">
      </div>
    </div>
  </section>
</template>
